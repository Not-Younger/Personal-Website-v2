...
const AboutPage: React.FC = () => {
  return (
    <div className="relative flex flex-col items-center justify-center lg:space-y-10 py-10">
      ...
      <Section text="My other hobbies are working out, working on side projects, gaming, and hanging out with family, friends, or girlfriend. My favorite kind of music is anything EDM / House." image="/championship.jpeg" alt="Championship picture" />
    </div>
  );
};
